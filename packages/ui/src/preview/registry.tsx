...
const TEXT_EXTENSIONS = [
  // plain
  'txt', 'log', 'text', 'csv', 'tsv',
  // web
  'js', 'jsx', 'mjs', 'cjs', 'ts', 'tsx', 'mts', 'cts', 'css', 'scss', 'less', 'vue', 'svelte',
  // data and config
  'json', 'jsonc', 'json5', 'yaml', 'yml', 'toml', 'ini', 'conf', 'cfg', 'env', 'properties',
  'xml', 'svg', 'graphql', 'gql', 'proto', 'lock',
  // languages
  'py', 'rb', 'go', 'rs', 'java', 'kt', 'kts', 'swift', 'c', 'h', 'cc', 'cpp', 'hpp', 'cs',
  'php', 'lua', 'r', 'scala', 'dart', 'sql', 'pl', 'ex', 'exs', 'erl', 'hs', 'clj', 'zig',
  // shells and tooling
  'sh', 'bash', 'zsh', 'fish', 'ps1', 'bat', 'cmd', 'make', 'mk', 'dockerfile', 'diff', 'patch',
]
